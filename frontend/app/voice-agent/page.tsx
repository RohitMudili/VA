  ...
  useEffect(() => {
    ...
    const connectToVoiceAgent = async () => {
      ...
      try {
        ...
        // Step 1: Start agent (creates room if needed)
        console.log('Starting agent...')
        const agentResponse = await apiService.startAgent(undefined, 'default')
      ...
      <header className="w-full bg-white shadow-sm py-4">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex items-center">
            <Link
              href="/"
              className="flex items-center text-gray-700 hover:text-[#0A64BC] transition-colors hover-lift click-shrink"
            >
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
        <div className="w-full max-w-4xl flex flex-col items-center">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6 sm:mb-8 text-center">
            <span className="text-[#0A64BC]">Echovest</span> by PolymAIths
          </h1>
          <p className="text-gray-600 text-center mb-8 max-w-2xl">
            Your voice-first smart agent for US real estate investors. Ask me about real estate investing or any of PolymAIths' AI ecosystems.
          </p>
            ...
            {isConnecting ? (
              <div className="absolute inset-0 bg-[#0f172a] flex flex-col items-center justify-center">
                ...
                <p className="text-white text-lg">
                  {roomName ? 'Connecting to Echovest...' : 'Initializing Echovest...'}
                </p>
              </div>
            ) : connectionError ? (
          ...
          <div className="mt-4 flex items-center justify-center space-x-2 text-xs">
            ...
            <span className="text-gray-500">
              {backendConnected === null ? 'Checking backend...' :
               ...
               isConnected ? 'Echovest connected' :
            ...
            <div className="mt-8 w-full max-w-2xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm text-gray-700">
                  🏠 "How can Echovest help me with real estate investing?"
                </div>
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm text-gray-700">
                  💡 "Tell me about Evernest for property developers"
                </div>
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm text-gray-700">
                  🏥 "What is Opencare for healthcare?"
                </div>
                <div className="bg-blue-50 border border-blue-100 rounded-lg p-3 text-sm text-gray-700">
                  🤝 "Who is behind PolymAIths?"
                </div>
              </div>
            </div>
          )}
