...
export default function AIVoiceAgentsPage() {
  ...
  return (
    <>
      {/* Google Analytics – disabled inside next-lite preview */}
      {!isPreviewHost && (
        <>
          <Script
            src="https://www.googletagmanager.com/gtag/js?id=G-KXLM8N87MK"
            strategy="afterInteractive"
            onError={(e) => console.warn("GA script failed to load:", e)}
          />
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-2 border-[#0A64BC] text-[#0A64BC] hover:bg-[#0A64BC] hover:text-white px-8 py-4 text-lg font-medium focus-ring transition-all duration-300 bg-transparent"
                    asChild
                  >
            ...
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  AI voice agents are sophisticated software programs that use artificial intelligence to conduct
                  natural, human-like conversations over the phone or through voice interfaces.
                </p>
              </div>
            ...
            <div className="space-y-6 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-white text-white hover:bg-white hover:text-[#0A64BC] px-8 py-4 text-lg font-medium transition-all duration-300 bg-transparent"
                  asChild
                >
